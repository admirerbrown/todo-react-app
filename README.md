...
<div align="center">
  ...
  <h3><b>React basic Todo-App README </b></h3>
...
> Simple todo add that accepts adding todos, deleting, editing, checking and marking todos as completed to improve on the basics of building a react app from scratch.
...
> JSX, JavaScript,CSS AND React library
...
```JavaScipt
cd clone https://github.com/admirerbrown/todo-react-app.git
```
...
Feel free to check the [issues page](https://github.com/admirerbrown/todo-react-app/issues).
